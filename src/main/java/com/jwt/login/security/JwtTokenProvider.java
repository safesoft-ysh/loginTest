...
public class JwtTokenProvider {
    ...
    private String secretKey = "yangsooho";
    ...
    public String createToken(String username, List<String> roles) {
        ...
        //Payload 정보 저장.
        Claims payloads = Jwts.claims().setSubject(username); // JWT payload 에 저장되는 정보단위
        payloads.put("roles", roles); // 정보는 key / value 쌍으로 저장된다.
